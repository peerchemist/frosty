...
class CargoBuildOptions {
  ...
  new({required this.toolchain, required this.flags});
...
class PrecompiledBinaries {
  ...
  new({required this.uriPrefix, required this.publicKey});
...
class CargokitCrateOptions {
  new({this.cargo = const {}, this.precompiledBinaries});
...
class CargokitUserOptions {
  ...
  new({required this.usePrecompiledBinaries, required this.verboseLogging});

...
class InvalidSignDetails(super.message) extends MessageException;
...
class SignDetails({
  ...
  required final Uint8List? mastHash,
}) with cl.Writable {
  this {
  ...
  factory fromReader(cl.BytesReader reader) {
  ...
  factory fromHex(String hex) => SignDetails.fromBytes(cl.hexToBytes(hex));
  ...
  new keySpend({required Uint8List message, Uint8List? mastHash})
  ...
  new scriptSpend({required Uint8List message})

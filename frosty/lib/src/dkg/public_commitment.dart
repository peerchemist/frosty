...
class InvalidPublicCommitment(super.message) extends MessageException;
...
class DkgPublicCommitment
    extends WritableRustObjectWrapper<rust.DkgPublicCommitmentOpaque> {
  ...
  Uint8List serializeImpl() =>
      rust.publicCommitmentToBytes(commitment: underlying);
}

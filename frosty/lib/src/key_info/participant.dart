...
class ParticipantKeyInfo({
  required final GroupKeyInfo group,
  required final PublicSharesKeyInfo publicShares,
  required final PrivateKeyInfo private,
}) extends KeyInfoWithGroupKey {
  this {

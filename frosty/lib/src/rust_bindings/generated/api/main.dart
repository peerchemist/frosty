...
}) => RustLib.instance.api.crateApiMainPublicCommitmentToBytes(
...
Uint8List signingCommitmentToBytes({required SigningCommitments commitment}) =>
    RustLib.instance.api.crateApiMainSigningCommitmentToBytes(
      commitment: commitment,
    );
...
}) => RustLib.instance.api.crateApiMainAesGcmEncrypt(
  key: key,
  plaintext: plaintext,
);
...
}) => RustLib.instance.api.crateApiMainAesGcmDecrypt(
  key: key,
...
class AesGcmCiphertext {
  ...
  const AesGcmCiphertext({required this.data, required this.nonce});
...
sealed class DkgRound2Error with _$DkgRound2Error implements FrbException {
  ...
  const factory DkgRound2Error.general({required String message}) =
...
sealed class SignAggregationError
  ...
  const factory SignAggregationError.general({required String message}) =
